...
<head>
  ...
  <!-- Nucleo Icons -->
  <link href="../src/main/webapp/assets/css/nucleo-icons.css" rel="stylesheet" />
  <link href="../src/main/webapp/assets/css/nucleo-svg.css" rel="stylesheet" />
  <!-- Font Awesome Icons -->
  <script src="https://kit.fontawesome.com/42d5adcbca.js" crossorigin="anonymous"></script>
  <link href="../src/main/webapp/assets/css/nucleo-svg.css" rel="stylesheet" />
  <!-- CSS Files -->
  <link id="pagestyle" href="../src/main/webapp/assets/css/soft-ui-dashboard.css?v=1.0.5" rel="stylesheet" />
</head>
          ...
          <div class="row">
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-left bg-transparent">
                  <h3 class="font-weight-bolder text-info text-gradient">Bentornato</h3>
                </div>
                <div class="card-body">
                  <form role="form" action="ConnessioneDB_servlet" method="POST">
                    <label>Username</label>
                    <div class="mb-3">
                      <input required="" autofocus="" name="username" type="text" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="email-addon">
                    </div>
                    <label>Password</label>
                    <div class="mb-3">
                      <input required="" name="password" type="password" class="form-control" placeholder="Password" aria-label="Password" aria-describedby="password-addon">
                    </div>
                    <div class="form-check form-switch">
                      <input class="form-check-input" type="checkbox" id="rememberMe" checked="" value="true" name="rememberMe">
            ...
            <div class="col-md-6">
              <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
                <div class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6" style="background-image:url('../src/main/webapp/assets/img/curved-images/curved6.jpg')"></div>
              </div>
            </div>
          </div>
        </div>
